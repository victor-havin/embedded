...
void debug_print_component(Component* component)
{
    ...
    if(kind < Component::Kind::UNKNOWN || kind > Component::Kind::ZONE) 
...
void Component::set_visible(bool visible) {
    embo::lock_guard<UIComposer*>(get_composer());
